 ...
 * @date 19-05-2014 18:28 (SPAIN)
 * @observations
 * 
 */
class ComponentZip extends TheFrameworkComponent
{
    ...
    //             GETS
    //==================================
    private function get_path_source($sFileFolder){ return $this->sPathSource.TFW_DS.$sFileFolder;}
    private function get_path_target($sFileFolder){ return $this->sPathTarget.TFW_DS.$sFileFolder;}
}