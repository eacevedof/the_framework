...
class ComponentDebug
{
    ...
    public static function get_messages_in_html_table(){if(self::$_isMessagesOn) echo self::build_html_table(self::$arMessages);}
   
    public static function get_sqls_in_array(){if(self::$_isSqlsOn) return self::$arSqls;}

    public static function get_sqls_in_html_table(){ if(self::$_isSqlsOn) echo self::build_html_table(self::$arSqls);}
...
";
    ...
    {
        if(is_array($_SESSION["componentdebug"]))
        {
