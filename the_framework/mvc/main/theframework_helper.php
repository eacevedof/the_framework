 ...
 * @date 09-10-2014 16:11
 * @observations:
 */
class TheFrameworkHelper extends TheFramework
{
    protected $_comments = "";
    protected $_type = "";
    protected $_id = "";
    ...
    {
        // clientbrowser, ismovildevice,consolecalled,permalink
        parent::__construct();
    }
    ...
    */
    ...
    protected function concat_param_value($sParamName,$value)
    {
        $value=urlencode($value);
        return "$sParamName=$value";
    }  
    ...
    protected function extract_values($arFields, $arFieldNames, $asArray=false, $sSeparator="-")
    {
        ...
        foreach($arFields as $sFieldName=>$value)
            if(in_array($sFieldName, $arFieldNames)) $arExtracted[] = $value;
    ...
    protected function set_style($value){$this->_style = $value;}
