 ...
 * @version 1.0.1
 * @name ControllerProjectTasks
 * @file controller_projecttasks.php   
 * @date 29-10-2014 09:54 (SPAIN)
 * @observations: 
 * @requires:
 */
//TFW
...
//APP
import_model("user,project_array,project_task,type_priority,type_status,type_percent,project");
...
class ControllerProjectTasks extends TheApplicationController
{
    protected $oProjectTask;

    public function __construct()
    {
        
        $this->sModuleName = "projecttasks";
        //console,pgpage,clientdevice,sesuser,aftersucces,currop  | log,session,permission,view
        parent::__construct($this->sModuleName);
        $this->oProjectTask = new ModelProjectTask();
        $this->oProjectTask->set_platform($this->oSessionUser->get_platform());
        if($this->is_inget("id"))
        {
            $this->oProjectTask->set_id($this->get_get("id"));
            $this->oProjectTask->load_by_id();
        }
        //$this->oSessionUser->set_dataowner_table($this->oProjectTask->get_table_name());
        //$this->oSessionUser->set_dataowner_tablefield("id_customer");
        //$this->oSessionUser->set_dataowner_keys(array("id"=>$this->oProjectTask->get_id()));
    }
...
//<editor-fold defaultstate="collapsed" desc="LIST">
    ...
    protected function build_list_scrumbs()
    {
        ...
        $arLinks["list"]=array("href"=>$sUrlLink,"innerhtml"=>tr_ptt_entities);
    ...
    protected function build_list_tabs()
    {
        ...
        //$arTabs["list"]=array("href"=>$sUrlTab,"innerhtml"=>tr_ptt_listtabs_1);
        //$sUrlTab = $this->buld_url($this->sModuleName,NULL,"get_list_by_foreign","id_foreign=".$this->get_get("id_parent_foreign"));
        //$arTabs["listbyforeign"]=array("href"=>$sUrlTab,"innerhtml"=>tr_ptt_listtabs_2);
    ...
    {
        $arOpButtons = array();
        $arOpButtons["filters"]=array("href"=>"javascript:reset_filters();","icon"=>"awe-magic","innerhtml"=>tr_ptt_listopbutton_filters);
        $arOpButtons["reload"]=array("href"=>"javascript:TfwControl.form_submit();","icon"=>"awe-refresh","innerhtml"=>tr_ptt_listopbutton_reload);
        if($this->oPermission->is_insert())
            $arOpButtons["insert"]=array("href"=>$this->build_url($this->sModuleName,NULL,"insert"),"icon"=>"awe-plus","innerhtml"=>tr_ptt_listopbutton_insert);
        if($this->oPermission->is_quarantine())
            $arOpButtons["multiquarantine"]=array("href"=>"javascript:multi_quarantine();","icon"=>"awe-remove","innerhtml"=>tr_ptt_listopbutton_multiquarantine);
        //if($this->oPermission->is_delete())
            //$arOpButtons["multidelete"]=array("href"=>"javascript:multi_delete();","icon"=>"awe-remove","innerhtml"=>tr_ptt_listopbutton_multidelete);
        //PICK WINDOWS
        //$arOpButtons["multiassign"]=array("href"=>"javascript:multiassign_window('projecttasks',null,'multiassign','projecttasks','addexternaldata');","icon"=>"awe-external-link","innerhtml"=>tr_ptt_listopbutton_multiassign);
        //$arOpButtons["singleassign"]=array("href"=>"javascript:single_pick('projecttasks','singleassign','txtI','txtI');","icon"=>"awe-external-link","innerhtml"=>tr_ptt_listopbutton_singleassign);
        $oOpButtons = new AppHelperButtontabs(tr_ptt_entities);
    ...
    protected function load_config_list_filters()
    {
        ...
        //notes_to
        $this->set_filter("notes_to","txtNotesTo",array("operator"=>"like"));
        //description
    ...
    protected function set_listfilters_from_post()
    {
        ...
        //notes_to
        $this->set_filter_value("notes_to",$this->get_post("txtNotesTo"));
        //description
    ...
    protected function get_list_filters()
    {
        ...
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("txtId",tr_ptt_fil_id));
        $arFields[] = $oAuxWrapper;
        //code_erp
        //$oAuxField = new HelperInputText("txtCodeErp","txtCodeErp");
        //$oAuxField->set_value($this->get_post("txtCodeErp"));
        //$oAuxField->on_entersubmit();
        //$oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("txtCodeErp",tr_ptt_fil_code_erp));
        //$arFields[] = $oAuxWrapper;
        //id_type_priority
        $oTypePriority = new ModelProjectTaskArray();
        ...
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdTypePriority",tr_ptt_fil_id_type_priority));
        $arFields[] = $oAuxWrapper;
        //id_type_status
        $oTypeStatus = new ModelProjectTaskArray();
        ...
        $oAuxField->set_postback();
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdTypeStatus",tr_ptt_fil_id_type_status));
        $arFields[] = $oAuxWrapper;
        //id_type_percent
        $oTypePercent = new ModelProjectTaskArray();
        ...
        $oAuxField->set_postback();
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdTypePercent",tr_ptt_fil_id_type_percent));
        $arFields[] = $oAuxWrapper;
        //id_project
        ...
        $oAuxField->set_postback();
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdProject",tr_ptt_fil_id_project));
        $arFields[] = $oAuxWrapper;
        //id_user_to
        $oUserTo = new ModelUserTo();
        ...
        $oAuxField->set_postback();
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdUserTo",tr_ptt_fil_id_user_to));
        $arFields[] = $oAuxWrapper;
        //id_user_by
        $oUserBy = new ModelUserBy();
        ...
        $oAuxField->set_postback();
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdUserBy",tr_ptt_fil_id_user_by));
        $arFields[] = $oAuxWrapper;
        //hours
        $oAuxField = new HelperInputText("txtHours","txtHours");
        $oAuxField->set_value($this->get_post("txtHours"));
        $oAuxField->on_entersubmit();
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("txtHours",tr_ptt_fil_hours));
        $arFields[] = $oAuxWrapper;
        //notes_to
        $oAuxField = new HelperInputText("txtNotesTo","txtNotesTo");
        $oAuxField->set_value($this->get_post("txtNotesTo"));
        $oAuxField->on_entersubmit();
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("txtNotesTo",tr_ptt_fil_notes_to));
        $arFields[] = $oAuxWrapper;
        //description
        //$oAuxField = new HelperInputText("txtDescription","txtDescription");
        //$oAuxField->set_value($this->get_post("txtDescription"));
        //$oAuxField->on_entersubmit();
        //$oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("txtDescription",tr_ptt_fil_description));
        //$arFields[] = $oAuxWrapper;
        //date_open
        $oAuxField = new HelperInputText("txtDateOpen","txtDateOpen");
        $oAuxField->set_value($this->get_post("txtDateOpen"));
        $oAuxField->on_entersubmit();
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("txtDateOpen",tr_ptt_fil_date_open));
        $arFields[] = $oAuxWrapper;
        //date_close
        $oAuxField = new HelperInputText("txtDateClose","txtDateClose");
        $oAuxField->set_value($this->get_post("txtDateClose"));
        $oAuxField->on_entersubmit();
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("txtDateClose",tr_ptt_fil_date_close));
        $arFields[] = $oAuxWrapper;
        //notes_detail
        $oAuxField = new HelperInputText("txtNotesDetail","txtNotesDetail");
        $oAuxField->set_value($this->get_post("txtNotesDetail"));
        $oAuxField->on_entersubmit();
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("txtNotesDetail",tr_ptt_fil_notes_detail));
        $arFields[] = $oAuxWrapper;
        return $arFields;
    }//get_list_filters()
    ...
    {
        $arColumns["id"] = tr_ptt_col_id;
        //$arColumns["code_erp"] = tr_ptt_col_code_erp;
        //$arColumns["id_type_priority"] = tr_ptt_col_id_type_priority;
        $arColumns["priority"] = tr_ptt_col_id_type_priority;
        //$arColumns["id_type_status"] = tr_ptt_col_id_type_status;
        $arColumns["status"] = tr_ptt_col_id_type_status;
        //$arColumns["id_type_percent"] = tr_ptt_col_id_type_percent;
        $arColumns["percent"] = tr_ptt_col_id_type_percent;
        //$arColumns["id_project"] = tr_ptt_col_id_project;
        $arColumns["project"] = tr_ptt_col_id_project;
        //$arColumns["id_user_to"] = tr_ptt_col_id_user_to;
        $arColumns["userto"] = tr_ptt_col_id_user_to;
        //$arColumns["id_user_by"] = tr_ptt_col_id_user_by;
        $arColumns["userby"] = tr_ptt_col_id_user_by;
        $arColumns["hours"] = tr_ptt_col_hours;
        $arColumns["notes_to"] = tr_ptt_col_notes_to;
        //$arColumns["description"] = tr_ptt_col_description;
        $arColumns["date_open"] = tr_ptt_col_date_open;
        $arColumns["date_close"] = tr_ptt_col_date_close;
        $arColumns["notes_detail"] = tr_ptt_col_notes_detail;
        return $arColumns;
    }//get_list_columns()
    ...
    public function get_list()
    {
        ...
        //("href"=>"url_lines","innerhtml"=>tr_ptt_order_lines,"class"=>"btn btn-info","icon"=>"awe-info-sign")));
...
//<editor-fold defaultstate="collapsed" desc="INSERT">
    ...
    protected function build_insert_scrumbs()
    {
        ...
        $arLinks["insert"]=array("href"=>$sUrlLink,"innerhtml"=>tr_ptt_entity_insert);
        $oScrumbs = new AppHelperBreadscrumbs($arLinks);
        return $oScrumbs;
    ...
    protected function build_insert_tabs()
    {
        ...
        //$arTabs["insert1"]=array("href"=>$sUrlTab,"innerhtml"=>tr_ptt_instabs_1);
        //$sUrlTab = $this->build_url($this->sModuleName,NULL,"insert2");
        //$arTabs["insert2"]=array("href"=>$sUrlTab,"innerhtml"=>tr_ptt_instabs_2);
    ...
    {
        $arOpButtons = array();
        $arOpButtons["list"] = array("href"=>$this->build_url(),"icon"=>"awe-search","innerhtml"=>tr_ptt_insopbutton_list);
        //$arOpButtons["extra"] = array("href"=>$this->build_url(),"icon"=>"awe-xxxx","innerhtml"=>tr_ptt_insopbutton_extra1);
        $oOpButtons = new AppHelperButtontabs(tr_ptt_entities);
        $oOpButtons->set_tabs($arOpButtons);
        return $oOpButtons;
    ...
    protected function build_insert_fields($usePost=0)
    {
        ...
        $arFields[]= new AppHelperFormhead(tr_ptt_entity_new);
        //id
        //$oAuxField = new HelperInputText("txtId","txtId");
        ...
        //$oAuxLabel = new HelperLabel("txtCodeErp",tr_ptt_ins_code_erp,"lblCodeErp");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        //$arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //id_type_priority
        $oTypePriority = new ModelProjectTaskArray();
        ...
        $oAuxField = new HelperSelect($arOptions,"selIdTypePriority","selIdTypePriority");
        $oAuxField->set_value_to_select($this->get_post("selIdTypePriority"));
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdTypePriority",tr_ptt_ins_id_type_priority));
        if($usePost) $oAuxField->set_value_to_select($this->get_post("selIdTypePriority"));
        $oAuxLabel = new HelperLabel("selIdTypePriority",tr_ptt_ins_id_type_priority,"lblIdTypePriority");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //id_type_status
        $oTypeStatus = new ModelProjectTaskArray();
        ...
        $oAuxField = new HelperSelect($arOptions,"selIdTypeStatus","selIdTypeStatus");
        $oAuxField->set_value_to_select($this->get_post("selIdTypeStatus"));
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdTypeStatus",tr_ptt_ins_id_type_status));
        if($usePost) $oAuxField->set_value_to_select($this->get_post("selIdTypeStatus"));
        $oAuxLabel = new HelperLabel("selIdTypeStatus",tr_ptt_ins_id_type_status,"lblIdTypeStatus");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //id_type_percent
        $oTypePercent = new ModelProjectTaskArray();
        ...
        $oAuxField = new HelperSelect($arOptions,"selIdTypePercent","selIdTypePercent");
        $oAuxField->set_value_to_select($this->get_post("selIdTypePercent"));
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdTypePercent",tr_ptt_ins_id_type_percent));
        if($usePost) $oAuxField->set_value_to_select($this->get_post("selIdTypePercent"));
        $oAuxLabel = new HelperLabel("selIdTypePercent",tr_ptt_ins_id_type_percent,"lblIdTypePercent");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //id_project
        $oProject = new ModelProject();
        ...
        $oAuxField = new HelperSelect($arOptions,"selIdProject","selIdProject");
        $oAuxField->set_value_to_select($this->get_post("selIdProject"));
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdProject",tr_ptt_ins_id_project));
        if($usePost) $oAuxField->set_value_to_select($this->get_post("selIdProject"));
        $oAuxLabel = new HelperLabel("selIdProject",tr_ptt_ins_id_project,"lblIdProject");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //id_user_to
        $oUserTo = new ModelUserTo();
        ...
        $oAuxField = new HelperSelect($arOptions,"selIdUserTo","selIdUserTo");
        $oAuxField->set_value_to_select($this->get_post("selIdUserTo"));
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdUserTo",tr_ptt_ins_id_user_to));
        if($usePost) $oAuxField->set_value_to_select($this->get_post("selIdUserTo"));
        $oAuxLabel = new HelperLabel("selIdUserTo",tr_ptt_ins_id_user_to,"lblIdUserTo");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //id_user_by
        $oUserBy = new ModelUserBy();
        ...
        $oAuxField = new HelperSelect($arOptions,"selIdUserBy","selIdUserBy");
        $oAuxField->set_value_to_select($this->get_post("selIdUserBy"));
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdUserBy",tr_ptt_ins_id_user_by));
        if($usePost) $oAuxField->set_value_to_select($this->get_post("selIdUserBy"));
        $oAuxLabel = new HelperLabel("selIdUserBy",tr_ptt_ins_id_user_by,"lblIdUserBy");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //hours
        $oAuxField = new HelperInputText("txtHours","txtHours");
        ...
        $oAuxLabel = new HelperLabel("txtHours",tr_ptt_ins_hours,"lblHours");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //notes_to
        $oAuxField = new HelperInputText("txtNotesTo","txtNotesTo");
        if($usePost) $oAuxField->set_value($this->get_post("txtNotesTo"));
        $oAuxLabel = new HelperLabel("txtNotesTo",tr_ptt_ins_notes_to,"lblNotesTo");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //description
        //$oAuxField = new HelperInputText("txtDescription","txtDescription");
        //if($usePost) $oAuxField->set_value($this->get_post("txtDescription"));
        //$oAuxLabel = new HelperLabel("txtDescription",tr_ptt_ins_description,"lblDescription");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        //$arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //date_open
        $oAuxField = new HelperInputText("txtDateOpen","txtDateOpen");
        if($usePost) $oAuxField->set_value($this->get_post("txtDateOpen"));
        $oAuxLabel = new HelperLabel("txtDateOpen",tr_ptt_ins_date_open,"lblDateOpen");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //date_close
        $oAuxField = new HelperInputText("txtDateClose","txtDateClose");
        if($usePost) $oAuxField->set_value($this->get_post("txtDateClose"));
        $oAuxLabel = new HelperLabel("txtDateClose",tr_ptt_ins_date_close,"lblDateClose");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //notes_detail
        $oAuxField = new HelperInputText("txtNotesDetail","txtNotesDetail");
        if($usePost) $oAuxField->set_value($this->get_post("txtNotesDetail"));
        $oAuxLabel = new HelperLabel("txtNotesDetail",tr_ptt_ins_notes_detail,"lblNotesDetail");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //SAVE BUTTON
        $oAuxField = new HelperButtonBasic("butSave",tr_ptt_ins_savebutton);
    ...
    protected function get_insert_validate()
    {
        ...
        //$arFieldsConfig["id"] = array("controlid"=>"txtId","label"=>tr_ptt_ins_id,"length"=>9,"type"=>array("numeric","required"));
        //$arFieldsConfig["code_erp"] = array("controlid"=>"txtCodeErp","label"=>tr_ptt_ins_code_erp,"length"=>25,"type"=>array());
        //$arFieldsConfig["id_type_priority"] = array("controlid"=>"selIdTypePriority","label"=>tr_ptt_ins_id_type_priority,"length"=>4,"type"=>array());
        //$arFieldsConfig["id_type_status"] = array("controlid"=>"selIdTypeStatus","label"=>tr_ptt_ins_id_type_status,"length"=>4,"type"=>array());
        //$arFieldsConfig["id_type_percent"] = array("controlid"=>"selIdTypePercent","label"=>tr_ptt_ins_id_type_percent,"length"=>4,"type"=>array());
        //$arFieldsConfig["id_project"] = array("controlid"=>"selIdProject","label"=>tr_ptt_ins_id_project,"length"=>9,"type"=>array());
        //$arFieldsConfig["id_user_to"] = array("controlid"=>"selIdUserTo","label"=>tr_ptt_ins_id_user_to,"length"=>9,"type"=>array());
        //$arFieldsConfig["id_user_by"] = array("controlid"=>"selIdUserBy","label"=>tr_ptt_ins_id_user_by,"length"=>9,"type"=>array());
        $arFieldsConfig["hours"] = array("controlid"=>"txtHours","label"=>tr_ptt_ins_hours,"length"=>5,"type"=>array("numeric"));
        $arFieldsConfig["notes_to"] = array("controlid"=>"txtNotesTo","label"=>tr_ptt_ins_notes_to,"length"=>250,"type"=>array());
        //$arFieldsConfig["description"] = array("controlid"=>"txtDescription","label"=>tr_ptt_ins_description,"length"=>200,"type"=>array());
        $arFieldsConfig["date_open"] = array("controlid"=>"txtDateOpen","label"=>tr_ptt_ins_date_open,"length"=>8,"type"=>array());
        $arFieldsConfig["date_close"] = array("controlid"=>"txtDateClose","label"=>tr_ptt_ins_date_close,"length"=>8,"type"=>array());
        $arFieldsConfig["notes_detail"] = array("controlid"=>"txtNotesDetail","label"=>tr_ptt_ins_notes_detail,"length"=>3000,"type"=>array());
...
//<editor-fold defaultstate="collapsed" desc="UPDATE">
    ...
    protected function build_update_scrumbs()
    {
        ...
        $arLinks["detail"]=array("href"=>$sUrlLink,"innerhtml"=>tr_ptt_entity.": ".$this->oProjectTask->get_id()." - ".$this->oProjectTask->get_description());
        $oScrumbs = new AppHelperBreadscrumbs($arLinks);
        return $oScrumbs;
    ...
    protected function build_update_tabs()
    {
        ...
        $arTabs["detail"]=array("href"=>$sUrlTab,"innerhtml"=>tr_ptt_updtabs_detail);
        //$sUrlTab = $this->build_url($this->sModuleName,"foreignamodule","get_list_by_foreign","id_foreign=".$this->get_get("id_parent_foreign"));
        //$arTabs["foreigndata"]=array("href"=>$sUrlTab,"innerhtml"=>tr_ptt_updtabs_foreigndata);
    ...
    protected function build_update_opbuttons()
    {
        ...
        if($this->oPermission->is_select())
            $arOpButtons["list"]=array("href"=>$this->build_url(),"icon"=>"awe-search","innerhtml"=>tr_ptt_updopbutton_list);
        //if($this->oPermission->is_insert())
            //$arOpButtons["insert"]=array("href"=>$this->build_url($this->sModuleName,NULL,"insert"),"icon"=>"awe-plus","innerhtml"=>tr_ptt_updopbutton_insert);
        if($this->oPermission->is_quarantine())
            $arOpButtons["delete"]=array("href"=>$this->build_url($this->sModuleName,NULL,"quarantine","id=".$this->get_get("id")),"icon"=>"awe-remove","innerhtml"=>tr_ptt_updopbutton_quarantine);
        //if($this->oPermission->is_delete())
            //$arOpButtons["delete"]=array("href"=>$this->build_url($this->sModuleName,NULL,"delete","id=".$this->get_get("id")),"icon"=>"awe-remove","innerhtml"=>tr_ptt_updopbutton_delete);
        $oOpButtons = new AppHelperButtontabs(tr_ptt_entities);
        $oOpButtons->set_tabs($arOpButtons);
        return $oOpButtons;
    ...
    protected function build_update_fields($usePost=0)
    {
        ...
        $oAuxLabel = new HelperLabel("txtId",tr_ptt_upd_id,"lblId");
        ...
        //if($usePost) $oAuxField->set_value($this->get_post("txtCodeErp"));
        //$oAuxLabel = new HelperLabel("txtCodeErp",tr_ptt_upd_code_erp,"lblCodeErp");
        //$oAuxLabel->add_class("labelpk");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        //$arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //id_type_priority
        ...
        $oAuxField = new HelperSelect($arOptions,"selIdTypePriority","selIdTypePriority");
        $oAuxField->set_value_to_select($this->get_post("selIdTypePriority"));
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdTypePriority",tr_ptt_upd_id_type_priority));
        $oAuxField->set_value_to_select($this->oProjectTask->get_id_type_priority());
        if($usePost) $oAuxField->set_value_to_select($this->get_post("selIdTypePriority"));
        $oAuxLabel = new HelperLabel("selIdTypePriority",tr_ptt_upd_id_type_priority,"lblIdTypePriority");
        $oAuxLabel->add_class("labelpk");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //id_type_status
        ...
        $oAuxField = new HelperSelect($arOptions,"selIdTypeStatus","selIdTypeStatus");
        $oAuxField->set_value_to_select($this->get_post("selIdTypeStatus"));
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdTypeStatus",tr_ptt_upd_id_type_status));
        $oAuxField->set_value_to_select($this->oProjectTask->get_id_type_status());
        if($usePost) $oAuxField->set_value_to_select($this->get_post("selIdTypeStatus"));
        $oAuxLabel = new HelperLabel("selIdTypeStatus",tr_ptt_upd_id_type_status,"lblIdTypeStatus");
        $oAuxLabel->add_class("labelpk");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //id_type_percent
        ...
        $oAuxField = new HelperSelect($arOptions,"selIdTypePercent","selIdTypePercent");
        $oAuxField->set_value_to_select($this->get_post("selIdTypePercent"));
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdTypePercent",tr_ptt_upd_id_type_percent));
        $oAuxField->set_value_to_select($this->oProjectTask->get_id_type_percent());
        if($usePost) $oAuxField->set_value_to_select($this->get_post("selIdTypePercent"));
        $oAuxLabel = new HelperLabel("selIdTypePercent",tr_ptt_upd_id_type_percent,"lblIdTypePercent");
        $oAuxLabel->add_class("labelpk");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //id_project
        ...
        $oAuxField = new HelperSelect($arOptions,"selIdProject","selIdProject");
        $oAuxField->set_value_to_select($this->get_post("selIdProject"));
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdProject",tr_ptt_upd_id_project));
        $oAuxField->set_value_to_select($this->oProjectTask->get_id_project());
        if($usePost) $oAuxField->set_value_to_select($this->get_post("selIdProject"));
        $oAuxLabel = new HelperLabel("selIdProject",tr_ptt_upd_id_project,"lblIdProject");
        $oAuxLabel->add_class("labelpk");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //id_user_to
        ...
        $oAuxField = new HelperSelect($arOptions,"selIdUserTo","selIdUserTo");
        $oAuxField->set_value_to_select($this->get_post("selIdUserTo"));
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdUserTo",tr_ptt_upd_id_user_to));
        $oAuxField->set_value_to_select($this->oProjectTask->get_id_user_to());
        if($usePost) $oAuxField->set_value_to_select($this->get_post("selIdUserTo"));
        $oAuxLabel = new HelperLabel("selIdUserTo",tr_ptt_upd_id_user_to,"lblIdUserTo");
        $oAuxLabel->add_class("labelpk");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //id_user_by
        ...
        $oAuxField = new HelperSelect($arOptions,"selIdUserBy","selIdUserBy");
        $oAuxField->set_value_to_select($this->get_post("selIdUserBy"));
        $oAuxWrapper = new ApphelperControlGroup($oAuxField,new HelperLabel("selIdUserBy",tr_ptt_upd_id_user_by));
        $oAuxField->set_value_to_select($this->oProjectTask->get_id_user_by());
        if($usePost) $oAuxField->set_value_to_select($this->get_post("selIdUserBy"));
        $oAuxLabel = new HelperLabel("selIdUserBy",tr_ptt_upd_id_user_by,"lblIdUserBy");
        $oAuxLabel->add_class("labelpk");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //hours
        ...
        if($usePost) $oAuxField->set_value(dbbo_numeric2($this->get_post("txtHours")));
        $oAuxLabel = new HelperLabel("txtHours",tr_ptt_upd_hours,"lblHours");
        $oAuxLabel->add_class("labelpk");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //notes_to
        $oAuxField = new HelperInputText("txtNotesTo","txtNotesTo");
        $oAuxField->set_value($this->oProjectTask->get_notes_to());
        if($usePost) $oAuxField->set_value($this->get_post("txtNotesTo"));
        $oAuxLabel = new HelperLabel("txtNotesTo",tr_ptt_upd_notes_to,"lblNotesTo");
        $oAuxLabel->add_class("labelpk");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //description
        ...
        //if($usePost) $oAuxField->set_value($this->get_post("txtDescription"));
        //$oAuxLabel = new HelperLabel("txtDescription",tr_ptt_upd_description,"lblDescription");
        //$oAuxLabel->add_class("labelpk");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        //$arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //date_open
        ...
        if($usePost) $oAuxField->set_value($this->get_post("txtDateOpen"));
        $oAuxLabel = new HelperLabel("txtDateOpen",tr_ptt_upd_date_open,"lblDateOpen");
        $oAuxLabel->add_class("labelpk");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //date_close
        ...
        if($usePost) $oAuxField->set_value($this->get_post("txtDateClose"));
        $oAuxLabel = new HelperLabel("txtDateClose",tr_ptt_upd_date_close,"lblDateClose");
        $oAuxLabel->add_class("labelpk");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //notes_detail
        $oAuxField = new HelperInputText("txtNotesDetail","txtNotesDetail");
        $oAuxField->set_value($this->oProjectTask->get_notes_detail());
        if($usePost) $oAuxField->set_value($this->get_post("txtNotesDetail"));
        $oAuxLabel = new HelperLabel("txtNotesDetail",tr_ptt_upd_notes_detail,"lblNotesDetail");
        $oAuxLabel->add_class("labelpk");
        //$oAuxField->readonly();$oAuxField->add_class("readonly");
        $arFields[] = new ApphelperControlGroup($oAuxField,$oAuxLabel);
        //BUTTON SAVE
        $oAuxField = new HelperButtonBasic("butSave",tr_ptt_upd_savebutton);
        $oAuxField->add_class("btn btn-primary");
    ...
    {
        $arFieldsConfig = array();
        $arFieldsConfig["id"] = array("controlid"=>"txtId","label"=>tr_ptt_upd_id,"length"=>9,"type"=>array("numeric","required"));
        //$arFieldsConfig["code_erp"] = array("controlid"=>"txtCodeErp","label"=>tr_ptt_upd_code_erp,"length"=>25,"type"=>array());
        //$arFieldsConfig["id_type_priority"] = array("controlid"=>"selIdTypePriority","label"=>tr_ptt_upd_id_type_priority,"length"=>4,"type"=>array());
        //$arFieldsConfig["id_type_status"] = array("controlid"=>"selIdTypeStatus","label"=>tr_ptt_upd_id_type_status,"length"=>4,"type"=>array());
        //$arFieldsConfig["id_type_percent"] = array("controlid"=>"selIdTypePercent","label"=>tr_ptt_upd_id_type_percent,"length"=>4,"type"=>array());
        //$arFieldsConfig["id_project"] = array("controlid"=>"selIdProject","label"=>tr_ptt_upd_id_project,"length"=>9,"type"=>array());
        //$arFieldsConfig["id_user_to"] = array("controlid"=>"selIdUserTo","label"=>tr_ptt_upd_id_user_to,"length"=>9,"type"=>array());
        //$arFieldsConfig["id_user_by"] = array("controlid"=>"selIdUserBy","label"=>tr_ptt_upd_id_user_by,"length"=>9,"type"=>array());
        $arFieldsConfig["hours"] = array("controlid"=>"txtHours","label"=>tr_ptt_upd_hours,"length"=>5,"type"=>array("numeric"));
        $arFieldsConfig["notes_to"] = array("controlid"=>"txtNotesTo","label"=>tr_ptt_upd_notes_to,"length"=>250,"type"=>array());
        //$arFieldsConfig["description"] = array("controlid"=>"txtDescription","label"=>tr_ptt_upd_description,"length"=>200,"type"=>array());
        $arFieldsConfig["date_open"] = array("controlid"=>"txtDateOpen","label"=>tr_ptt_upd_date_open,"length"=>8,"type"=>array());
        $arFieldsConfig["date_close"] = array("controlid"=>"txtDateClose","label"=>tr_ptt_upd_date_close,"length"=>8,"type"=>array());
        $arFieldsConfig["notes_detail"] = array("controlid"=>"txtNotesDetail","label"=>tr_ptt_upd_notes_detail,"length"=>3000,"type"=>array());
        return $arFieldsConfig;
    }//get_update_validate
...
//<editor-fold defaultstate="collapsed" desc="MULTIASSIGN">
    ...
    {
        $arOpButtons = array();
        $arOpButtons["filters"]=array("href"=>"javascript:reset_filters();","icon"=>"awe-magic","innerhtml"=>tr_ptt_clear_filters);
        $arOpButtons["reload"]=array("href"=>"javascript:TfwControl.form_submit();","icon"=>"awe-refresh","innerhtml"=>tr_ptt_refresh);
        $arOpButtons["multiadd"]=array("href"=>"javascript:multiadd();","icon"=>"awe-external-link","innerhtml"=>tr_ptt_multiadd);
        $arOpButtons["closeme"]=array("href"=>"javascript:closeme();","icon"=>"awe-remove-sign","innerhtml"=>tr_ptt_closeme);
        $oOpButtons = new AppHelperButtontabs(tr_ptt_entities);
        $oOpButtons->set_tabs($arOpButtons);
        return $oOpButtons;
...
//<editor-fold defaultstate="collapsed" desc="SINGLEASSIGN">
    ...
    {
        $arButTabs = array();
        $arButTabs["filters"]=array("href"=>"javascript:reset_filters();","icon"=>"awe-magic","innerhtml"=>tr_ptt_clear_filters);
        $arButTabs["reload"]=array("href"=>"javascript:TfwControl.form_submit();","icon"=>"awe-refresh","innerhtml"=>tr_ptt_refresh);
        $arButTabs["closeme"]=array("href"=>"javascript:closeme();","icon"=>"awe-remove-sign","innerhtml"=>tr_ptt_closeme);
        return $arButTabs;
