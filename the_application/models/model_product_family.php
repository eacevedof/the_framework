 ...
 * @version 1.0.2
 * @name ModelProductFamily
 * @file model_product_family.php     
 * @date 20-04-2013 00:20 (SPAIN)
 * @observations: 
 */
include_once("theapplication_model.php");

class ModelProductFamily extends TheApplicationModel
{
    private $_orderby; //int(4)
    private $_type; //varchar(15)

    public function __construct($id=NULL,$orderby=NULL,$type=NULL)
    {
        parent::__construct("app_product_family");
