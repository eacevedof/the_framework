 ...
 * @version 1.0.0
 * @name ModelPictureArray
 * @file model_picture_array.php
 * @date 22-09-2013 10:56 (SPAIN)
 * @observations: 
 * @requires: theapplication_model.php
 */
include_once("theapplication_model.php");

class ModelPictureArray extends TheApplicationModel
{
    ...
    {
        parent::__construct("app_picture_array");
